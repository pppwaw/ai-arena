...
def relative_radian(x1: float, y1: float, x2: float, y2: float, r1: Union[float, int, None]) -> Radian: ...


def relative_angle(x1: float, y1: float, x2: float, y2: float, a1: Union[float, int, None]) -> Degree: ...
